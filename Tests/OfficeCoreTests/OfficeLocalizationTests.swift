...
final class OfficeLocalizationTests: XCTestCase {
    ...
    func testNewUIStringsAreLocalizedInEnglish() {
        let testCases: [(korean: String, english: String)] = [
            ...
            ("대화를 삭제하지 못했습니다", "Could Not Delete Conversation"),
            ("이 대화와 관련된 업무 기록 및 검색 색인이 함께 삭제됩니다. 실행 중인 대화는 삭제할 수 없습니다.", "Related work records and search indexes will also be deleted. An active conversation cannot be deleted."),
